...
var style_APSCRWI_43 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= 0.583000 && value <= 0.646667) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.646667 && value <= 0.710333) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.710333 && value <= 0.774000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.774000 && value <= 0.810000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.810000 && value <= 0.846000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.846000 && value <= 0.882000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.882000 && value <= 0.899333) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.899333 && value <= 0.916667) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.916667 && value <= 0.934000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.934000 && value <= 0.946667) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.946667 && value <= 0.959333) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.959333 && value <= 0.972000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.972000 && value <= 1.004000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.004000 && value <= 1.036000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.036000 && value <= 1.068000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 50.0 + size, points: 4,
